  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-emerald-900 text-xl md:text-2xl">Explorar</span>
            </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 md:px-8 py-6 md:py-8">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-gray-900 mb-4 md:mb-6 text-xl md:text-2xl">
            Todas as empresas
          </h3>
              ...
              {companies.map((company) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div
                      className={`px-3 py-1 md:px-4 md:py-2 rounded-lg ${getScoreColor(company.esgScore)}`}
                    >
